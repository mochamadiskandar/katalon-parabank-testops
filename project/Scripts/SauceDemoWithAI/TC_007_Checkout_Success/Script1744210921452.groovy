...
// create script for saucedemo, for feature checkout success
...
// Input first name
WebUI.setText(findTestObject('Object Repository/SauceDemo/first_name'), 'John')
...
WebUI.click(findTestObject('Object Repository/SauceDemo/finish_button'))

// Verify the checkout success message
WebUI.verifyElementPresent(findTestObject('Object Repository/SauceDemo/checkout_success_message'), 10)
